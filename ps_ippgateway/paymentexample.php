 ...
 *
 * @author    IPP Europe <contact@ippeurope.com>
 * @copyright Since 2023 IPP Europe
...
class PaymentExample extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Display Payment Example');
        $this->description = $this->l('Handle payments with VISA or MasterCard');
    }
